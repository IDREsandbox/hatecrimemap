...
const CHART_COLORS = ["#275B61", "#228A96", "#1CC2C2", "#63E1C8", "#F7CE38", "#FB890E", "#E05215", "#9F2D3E", "#682731"]

const COVID_CHARTS_COLORS = ["#ED8512", "#87C44B", "#00743F", "#25B39F", "#0077CC", "#19235B"]
    ...
    datasets: [
      {
        ...
        backgroundColor: COVID_CHARTS_COLORS.map(c => c + "99"),
        borderColor: COVID_CHARTS_COLORS,
        borderWidth: 1,
        hoverBackgroundColor: COVID_CHARTS_COLORS.map(c => c + "66"),
        hoverBorderColor: COVID_CHARTS_COLORS
      }],
    labels: covidRE
  },
  {
